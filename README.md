...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyaladin-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12623&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyaladin-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyaladin` can be installed with:

```
conda install ipyaladin
```

It is possible to list all of the versions of `ipyaladin` available on your platform with:
